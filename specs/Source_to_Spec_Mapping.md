...
|--------|----------------|---------------------|
| **p1-4-to-p1-34-.pdf** (OCR: p1-4-to-p1-34-.txt) | Pages 1-4 (Report p1-4 to p1-7) | Supply voltage, system timing (1.5 MHz osc → 375 kHz Φ1/Φ2, bit time 2.666μsec, 20 bit times/word, WA/WO alternation, word mark at T18, 512 OPs/frame), data format (20-bit fractional fixed-point, sign + 19 magnitude, sign-and-magnitude, bit weights), circuit function overview intro |
...
| **ap1-26-97.pdf** (OCR: ap1-26-97.txt) | Pages 4-5 (Number System, Processor Parallelism) | Fixed-point fractional 20-bit, sign-and-magnitude choice, word length rationale, serial data transfer decision, pipelining architecture (multiple functional units: PMU/PDU/SLF/SL/RAS/ROM) |
...
| Source | Pages/Sections | Information Extracted |
|--------|----------------|---------------------|
| **p1-4-to-p1-34-.pdf** (OCR: p1-4-to-p1-34-.txt) | Pages 1-3 (Report p1-4 to p1-6) | System timing architecture — 1.5 MHz master osc, Φ1/Φ2 at 375 kHz, bit time definition, word time (T0–T19), WA/WO alternation, word mark (T18), OP time, frame mark, 512 OPs/frame |
