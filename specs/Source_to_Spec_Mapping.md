...
|--------|----------------|---------------------|
| **p1-4-to-p1-34-.pdf** (OCR: p1-4-to-p1-34-.txt) | Pages 1-4 (Report p1-4 to p1-7) | Supply voltage, system timing (1.5 MHz osc → 375 kHz Φ1/Φ2, bit time 2.666μsec, 20 bit times/word, WA/WO alternation, word mark at T18, 512 OPs/frame), data format (20-bit fractional fixed-point, sign + 19 data, 2's complement, bit weights), circuit function overview intro |
