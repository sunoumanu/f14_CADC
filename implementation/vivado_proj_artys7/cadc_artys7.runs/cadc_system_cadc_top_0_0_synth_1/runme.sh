...
HD_PWD='C:/Users/aptay/Dropbox/adiuvo/f14-CADC/implementation/vivado_proj_artys7/cadc_artys7.runs/cadc_system_cadc_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cadc_system_cadc_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cadc_system_cadc_top_0_0.tcl
