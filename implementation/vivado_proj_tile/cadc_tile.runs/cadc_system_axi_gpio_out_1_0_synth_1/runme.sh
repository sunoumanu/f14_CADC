...
HD_PWD='C:/Users/aptay/Dropbox/adiuvo/f14-CADC/implementation/vivado_proj_tile/cadc_tile.runs/cadc_system_axi_gpio_out_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cadc_system_axi_gpio_out_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cadc_system_axi_gpio_out_1_0.tcl
