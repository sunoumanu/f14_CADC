...
#ifndef _cadc_system_xlconcat_status_0_core_h_
#define _cadc_system_xlconcat_status_0_core_h_
...
class cadc_system_xlconcat_status_0_core : public sc_module 
{
    public: 
       cadc_system_xlconcat_status_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(cadc_system_xlconcat_status_0_core);
    ...
    virtual ~cadc_system_xlconcat_status_0_core() = default;
