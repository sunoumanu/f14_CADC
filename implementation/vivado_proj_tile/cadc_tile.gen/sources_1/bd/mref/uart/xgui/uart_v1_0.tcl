...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "reset_level" -parent ${Page_0}
...
proc update_PARAM_VALUE.reset_level { PARAM_VALUE.reset_level } {
	# Procedure called to update reset_level when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.reset_level { PARAM_VALUE.reset_level } {
	# Procedure called to validate reset_level
	return true
}


proc update_MODELPARAM_VALUE.reset_level { MODELPARAM_VALUE.reset_level PARAM_VALUE.reset_level } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.reset_level}] ${MODELPARAM_VALUE.reset_level}
}
