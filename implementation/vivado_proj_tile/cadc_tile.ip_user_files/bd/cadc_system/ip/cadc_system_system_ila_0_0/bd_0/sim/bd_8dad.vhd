...
----------------------------------------------------------------------------------
--Command: generate_target bd_8dad.bd
--Design : bd_8dad
...
entity bd_8dad is
  ...
  attribute CORE_GENERATION_INFO of bd_8dad : entity is "bd_8dad,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_8dad,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=12,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_8dad : entity is "cadc_system_system_ila_0_0.hwdef";
end bd_8dad;

architecture STRUCTURE of bd_8dad is
  component bd_8dad_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component bd_8dad_ila_lib_0;
  component bd_8dad_g_inst_0 is
  port (
    aclk : in STD_LOGIC;
    ...
    m_slot_2_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    m_slot_2_axis_tlast : out STD_LOGIC
  );
  end component bd_8dad_g_inst_0;
  component bd_8dad_slot_0_aw_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_8dad_slot_0_aw_0;
  component bd_8dad_slot_0_w_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_8dad_slot_0_w_0;
  component bd_8dad_slot_0_b_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_8dad_slot_0_b_0;
  component bd_8dad_slot_0_ar_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_8dad_slot_0_ar_0;
  component bd_8dad_slot_0_r_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_8dad_slot_0_r_0;
  component bd_8dad_slot_1_aw_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_8dad_slot_1_aw_0;
  component bd_8dad_slot_1_w_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_8dad_slot_1_w_0;
  component bd_8dad_slot_1_b_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_8dad_slot_1_b_0;
  component bd_8dad_slot_1_ar_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_8dad_slot_1_ar_0;
  component bd_8dad_slot_1_r_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_8dad_slot_1_r_0;
  ...
  signal net_slot_2_axis_tdata : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI:SLOT_2_AXIS, ASSOCIATED_RESET resetn, CLK_DOMAIN cadc_system_sys_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
  ...
  attribute X_INTERFACE_MODE of SLOT_1_AXI_araddr : signal is "Monitor SlaveType";
  ...
  attribute X_INTERFACE_PARAMETER of SLOT_2_AXIS_tdata : signal is "XIL_INTERFACENAME SLOT_2_AXIS, CLK_DOMAIN cadc_system_sys_clk, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 0, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0";
begin
g_inst: component bd_8dad_g_inst_0
     port map (
      aclk => clk,
      aresetn => resetn,
      ...
      m_slot_2_axis_tdata(7 downto 0) => net_slot_2_axis_tdata(7 downto 0),
      ...
      slot_2_axis_tdata(7 downto 0) => SLOT_2_AXIS_tdata(7 downto 0),
      slot_2_axis_tlast => SLOT_2_AXIS_tlast,
      slot_2_axis_tready => SLOT_2_AXIS_tready,
      slot_2_axis_tvalid => SLOT_2_AXIS_tvalid
    );
ila_lib: component bd_8dad_ila_lib_0
     port map (
      clk => clk,
      ...
      probe36(7 downto 0) => net_slot_2_axis_tdata(7 downto 0),
