...
#                script (type 'cadc_system.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/aptay/Dropbox/adiuvo/f14-CADC/implementation/vivado_proj_tile/cadc_tile.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
