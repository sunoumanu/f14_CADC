...
#
# Script generated by Vivado on Sun Apr 12 12:50:49 +0100 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cadc_system.sh
...
#
# Usage        : cadc_system.sh
#                cadc_system.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cadc_system.sh [-rerun]
#                cadc_system.sh [-reset_run]
#                cadc_system.sh [-clean]
#                cadc_system.sh [-reset_log]
#                cadc_system.sh [-help]
#
...
# script info
echo -e "cadc_system.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cadc_system.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L axi_vip_v1_1_22 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L util_vector_logic_v2_0_5 -L xlconcat_v2_1_7 -L gigantic_mux -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cadc_system xil_defaultlib.cadc_system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cadc_system -key {Behavioral:sim_1:Functional:cadc_system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fda1.protoinst" -protoinst "protoinst_files/bd_8dad.protoinst" -protoinst "protoinst_files/cadc_system.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cadc_system.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cadc_system.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cadc_system.sh [-help]\n\
Usage: cadc_system.sh [-step]\n\
Usage: cadc_system.sh [-lib_map_path]\n\
Usage: cadc_system.sh [-rerun]\n\
Usage: cadc_system.sh [-reset_run]\n\
Usage: cadc_system.sh [-clean]\n\
Usage: cadc_system.sh [-reset_log]\n\
Usage: cadc_system.sh [-keep_index]\n\
Usage: cadc_system.sh [-noclean_files]\n\n\
