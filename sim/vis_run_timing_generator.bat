@echo off
REM Timing Generator Testbench - Questa Visualizer Interactive Simulation
REM F-14A CADC - Master Timing and Synchronization
...
REM Compile sources
echo Compiling Timing Generator sources...
